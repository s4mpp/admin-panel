...
abstract class Label
{
    ...
    {
        return (new Text($title, $field))->strong();
    }
    ...
    public static function markDown(string $title, string $field): MarkDown
    {
        return new MarkDown($title, $field);
    }

    public static function date(string $title, string $field): Datetime
    {
        return new Datetime($title, $field, 'd/m/Y');
    }

    public static function datetime(string $title, string $field): Datetime
    {
        return new Datetime($title, $field, 'd/m/Y H:i');
    }

    public static function badge(string $title, string $field): Badge
    {
        return new Badge($title, $field);
    }

    public static function boolean(string $title, string $field): Boolean
    {
        return new Boolean($title, $field);
    }

    public static function file(string $title, string $field): File
    {
