...
@section('auth-content')
	<div class="card-auth-sm mx-auto">
		<p class="mb-4 text-center text-muted">Insira seu e-mail abaixo para recuperar sua senha.</p>
		...
		<form method="post" action="{{ route(S4mpp\Laraguard\Routes::recoveryPassword()) }}">
			...
			<div class="mx-auto d-grid">
				<button loading type="submit" class="btn btn-block btn-primary mt-3">Enviar e-mail</button>
			</div>
