...
<div class="overflow-hidden rounded-lg bg-white shadow">
	<div class="flex flex-col md:flex-row  ">
		...
		<div class="bg-slate-100 w-full md:w-4/12 ">
			<div class="px-4 py-4 sm:p-6 divide-y divide-slate-200">
				...
				<x-item-view title="Alterado em">{{ $register->updated_at->format('d/m/Y H:i') }} ({{ $register->updated_at->diffForHumans(['short' => true]) }})</x-item-view>
			</div>
		</div>
	</div>
</div>
